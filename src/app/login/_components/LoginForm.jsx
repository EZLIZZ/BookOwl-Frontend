  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[rgb(246,220,201)] relative px-4">
          ...
          <Form {...form}>
            ...
            >
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full mx-auto bg-[#5d768a] rounded-full flex items-center justify-center gap-2"
              >
                {loading && (
              ...
              <div className="text-center">
                <p className="text-sm text-[#a75257]">
                  ...
                  <a
                    href="/signuppage"
                    className="ml-1 text-[#8d767c] hover:underline"
                  >
                    Sign Up
                  </a>
                </p>
      ...
      <img
        src="/photos/logo.png"
        alt="Logo"
        className="absolute top-4 right-4 w-32 h-12 "
      />
    </div>
  );
}
